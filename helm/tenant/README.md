...
Once the [MinIO Operator Chart](https://github.com/lgj101/operator/tree/master/helm/operator) is successfully installed, create a MinIO Tenant using:
...
This creates a 4 Node MinIO Tenant (cluster). To change the default values, take a look at various [values.yaml](https://github.com/lgj101/operator/blob/master/helm/tenant/values.yaml).
