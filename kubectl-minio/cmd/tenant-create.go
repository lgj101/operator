...
import (
	...
	operatorv1 "github.com/lgj101/operator/pkg/client/clientset/versioned"
...
func newTenantCreateCmd(out io.Writer, errOut io.Writer) *cobra.Command {
	...
	f.StringVar(&c.tenantOpts.KmsSecret, "kes-config", "", "name of secret for KES KMS setup, refer https://github.com/lgj101/operator/blob/master/examples/kes-secret.yaml")
