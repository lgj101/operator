...
LDFLAGS ?= "-s -w -X github.com/lgj101/operator/pkg.ReleaseTag=$(VERSIONV) -X github.com/lgj101/operator/pkg.Version=$(VERSION) -X github.com/lgj101/operator/pkg.ShortCommitID=$(SHA)"
